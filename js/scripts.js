            ...
            <body>
                <div class="receipt-container">
                    ...
                    <div class="receipt-details">
                        ...
                        <p><span class="label">Duration:</span> ${booking.dateFrom} to ${booking.dateTo}</p>
                        <p><span class="label">Room No:</span> ${booking.roomNo}</p>
            ...
            <body>
                <div class="receipt-container">
                    ...
                    <div class="receipt-details">
                        ...
                        <p><span class="label">Accessories:</span> ${entry.accessories.join(', ')}</p>
                        <p><span class="label">Total Cost:</span> ${entry.totalCost}</p>
                    </div>
